...
/**
 * Fractions offer a level, a session length, and a personal challenge.
 *
 * Challenge lengths deliberately exclude the shortest (5-question) practice
 * option — the same "avoid noisy short records" reasoning already applied to
 * Multiplication Tables — and a pace personal best requires a flawless round,
 * so a faster-but-wrong run can never register as a new speed record.
 */
