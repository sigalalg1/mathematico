...
import { simpleFractionsGames } from '../data/games';
import { useAuth } from '../auth/useAuth';
import { getActivityHistory } from '../tracking/activityTracker';

export function SimpleFractionsPage() {
      ...
      <div className="card-grid">
        {simpleFractionsGames.map((game) => (
          <Card
            ...
            statusBadge={game.enabled && completedGameIds.has(game.id) ? `✓ ${t('simpleFractionsPage.completedBadge')}` : undefined}
          />
        ))}
      </div>
    </PageLayout>
